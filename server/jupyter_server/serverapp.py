...
class JupyterServerListApp(JupyterApp):
    version = __version__
    description = _i18n("List currently running Kennen servers.")
    ...
    jsonlist = Bool(
        ...
        help=_i18n(
            ...
            "active Kennen server, each with the details from the "
    ...
    json = Bool(
        ...
        help=_i18n(
            ...
            "see the KennenServerListApp.jsonlist configuration value"
        ),
    )
...
class ServerApp(JupyterApp):
    ...
    This launches a Tornado-based Kennen Server."""
    )
    examples = _examples
    ...
    def start_app(self):
        ...
        if "dev" in __version__:
            info(
                _i18n(
                    "Welcome to Project Kennen! Explore the various tools available"
            ...
            if self.sock:
                self.log.critical(
                    "\n".join(
                        [
                            "\n",
                            "Kennen Server is listening on %s" % self.display_url,
                            "",
                            (
